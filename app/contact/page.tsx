...
export const metadata: Metadata = {
  ...
  description: "Book a car wash or detailing at Luxury Car Care in Bidar. Call or WhatsApp +91 74162 38424, or use our online form. Open 6 AM to 9 PM every day.",
  alternates: { canonical: "https://lux-car-care.sindhole.com/contact" },
  openGraph: {
    title: "Contact & Booking — Luxury Car Care",
    description: "Book a car wash in Bidar. Call or WhatsApp +91 74162 38424, or use our online booking form.",
...
export default function ContactPage() {
  return (
    <>
              ...
              >
                ...
                <dl className="flex flex-col gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <dd><a href="tel:+917416238424" className="font-medium hover:underline" style={{ color: "var(--color-mahogany)" }}>+91 74162 38424</a></dd>
                  </div>
                  <div>
          ...
          >
            <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
              <div className="max-w-lg">
                ...
                >
                  Dedicated feedback line · +91 95500 92810
                </p>
              </div>
              <div className="flex shrink-0 flex-col gap-3 sm:items-end">
                <a
                  href="tel:+919550092810"
      ...
      <section id="map" className="section-pad" style={{ backgroundColor: "var(--color-surface)" }} aria-labelledby="map-heading">        <div className="mx-auto max-w-7xl px-5 lg:px-16">
